...
function GetFind_Data2(str) {
 ...
 var url="find_vm_logs1.php?host="+str
   ...
   function GotReturnFindData2() {
    if (req_fifo.readyState != 4 || req_fifo.status != 200) {
	 ...
	 val2='<font size=2 color=blue face=tahoma>Local Backup Log</font><br><table bgcolor="#ffffff" border="1" cellspacing=0 cellpadding=0 style="border-style: thin;" bordercolor="#e3e3e3"  width="100%" id="table1">';
	val2 +='<tr><td>';
