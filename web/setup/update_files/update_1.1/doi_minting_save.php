...
$app_id = "5ecc10189f830d1124db1bebeb57a5821fc328d8"; //Your ANDS APP_ID string
$shared_secret = "bf392f19bc"; // Your shared secret
...
$query=" Insert into nci_doi_main.nci_doi (`minting_id`, `date_post`, `landing_page`, `publisher`, `publication_year`, `xml_data`, `user_id`, `doi`, `language`, `resourcetype_general`, `resource_type`, `version`, `type`) values ($max_id, '$d','$doi_lpage','$doi_publisher','$doi_pyear','$strxml','$user_id','$doi','$dt_language','$rt_general','$r_type','$fd_version','production')";
$result=MYSQL_QUERY($query) ;
...
<br><br><br>
<a href="../php/doi_minting.php" ><image src="../images/back.png"></a>
