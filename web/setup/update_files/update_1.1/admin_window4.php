...
<font size=3 color=#800000>List of Project Admin
<br><br>
...
var leftPos = (w-popW)/2, topPos = (h-popH)/2;
 win2=window.open('delete_map4.php?guid='+str+'&group_id='+str1,'win2','toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=550,height=250,top=' + topPos + ',left=' + leftPos);
}
...
<td width=55% align=center>User ID</td>
<!--<td width=5% align=center></td>-->
</tr>

<?
$result1=@MYSQL_query("Select project_id,user_id from nci_metadata_general.project_admin");
