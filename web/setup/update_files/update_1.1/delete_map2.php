...
$group_id=valid_data($_REQUEST['group_id']);
 ...
 $query1="delete from nci_metadata_general.group_admin where group_id='$group_id' and user_id='$guid'"; 
 $result1=MYSQL_QUERY($query1);
  


echo "<br><br><br><center>Group Admin successfully deleted............<br><br>Please close this window and reload your main page to see the changes....";
...
<form name="ff1" method="post" action="delete_map2.php">
<br><br>
<center>

<font face='arial' size='4' color="#800000"><u>Delete Group Admin</u>
</font>
<br><br><br>

<table border=0 width=90% align=center>

 <td width="70%" colspan=2 align=center>Are You sure want to delete the Group Admin.....</td>
