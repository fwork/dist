...
<html>
<head>
 <?include_once ($inc_path.check_includes_file_exist('session_secret_handler').".php");?>
<div id="sessionTimeoutWarning" style="display: none"></div>
<link rel="stylesheet" type="text/css" href="../stylesheet/style.css">
<? include_once ($inc_path.check_includes_file_exist('session_expire_handler').".php");?>

<title>Admin Window</title></head>


<body>
<br>

<font size=3 color=#800000>List of Group/Project
<br><br>
...
var leftPos = (w-popW)/2, topPos = (h-popH)/2;
 win2=window.open('delete_map3.php?guid='+str+'&group_id='+str1,'win2','toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=550,height=250,top=' + topPos + ',left=' + leftPos);
}
...
<td width=55% align=center>Project ID</td>
<!--<td width=5% align=center></td>-->
</tr>

<?
$result1=@MYSQL_query("Select group_id,project_id from nci_metadata_general.group_project");
...
<td width=50% align=left><font size=2><?echo $row1['project_id'];?></font></td>
