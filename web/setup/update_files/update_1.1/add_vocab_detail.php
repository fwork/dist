...
$vowner_website=valid_data($_POST['vowner_website']);
 ...
 $res1=@MYSQL_QUERY("select max(vocab_id) as cc  from nci_vocabulary.vocabulary_main") ;
...
$user_id=@$_SESSION["uid_".session_id()] ;
$d=@date("Y-m-d H:i:s");
$txt=$d." : Vocabulary  with Title : ".$vtitle." is being added... by ".$user_id;
//log_save5($user_id,$txt);


echo "<br><br><br><center>Vocabulary successfully saved............<br><br>Please close this window and reload your main page to see the changes....";
...
<form name="ff1" method="post" action="add_vocab_detail.php"  enctype="multipart/form-data">

<br>

<font size=4 face='verdana' color=#800000><u>Add New Vocabulary</u></font>
